...
void PropertyBrowser::addMapProperties()
{
    ...
    addProperty(QuadWidthProperty, QVariant::Int, tr("Quad Width"), groupProperty);
    addProperty(QuadHeightProperty, QVariant::Int, tr("Quad Height"), groupProperty);
...
void PropertyBrowser::addTilesetProperties()
{
    ...
    if (!tileset->isCollection()) {
        ...
        QtVariantProperty *quadWidthProperty = addProperty(TileWidthProperty, QVariant::Int, tr("Tile Width"), parametersProperty);
        QtVariantProperty *quadHeightProperty = addProperty(TileHeightProperty, QVariant::Int, tr("Tile Height"), parametersProperty);
        ...
        quadWidthProperty->setEnabled(false);
        quadHeightProperty->setEnabled(false);
...
void PropertyBrowser::applyMapValue(PropertyId id, const QVariant &val)
{
    ...
    case TileHeightProperty:
        command = new ChangeMapProperty(mMapDocument, ChangeMapProperty::TileHeight,
                                        val.toInt());
        break;
    case QuadWidthProperty:
        command = new ChangeMapProperty(mMapDocument, ChangeMapProperty::QuadWidth,
                                        val.toInt());
        break;
    case QuadHeightProperty:
        command = new ChangeMapProperty(mMapDocument, ChangeMapProperty::QuadHeigth,
                                        val.toInt());
        break;
...
void PropertyBrowser::updateProperties()
{
    ...
    case Object::MapType: {
        ...
        mIdToProperty[QuadWidthProperty]->setValue(map->quadWidth());
        mIdToProperty[QuadHeightProperty]->setValue(map->quadHeight());
